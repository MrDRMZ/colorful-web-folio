<?php
    ...
    // ##**##**##** IMAGE UPLOADER ##**##**##**
    // ##**##This script processes the image uploaded ##**##
    if(isset($_POST['isMainPic'])){
      //is set main pic checkbox was checked
      $isMainPic = 1;// the value in the DB of isMainPic
    } else {
    ...
    if($isOkay == 1) { // if the file passed each and every test
        ...
        //ready to save new pic to DB
        //existing pic to isMainPic=0
        //if user checked checkbox-
        if($isMainPic == 1){
            $query0 = "UPDATE images SET isMainPic=0
                       WHERE isMainPic=1
                       AND catID=3
                       AND foreignID='$IDmbr'";
        ...
        $query = "INSERT INTO images(imgName, foreignID, catID, isMainPic)
                  VALUES('$fileToUpload', '$IDmbr', 3, 1)";
